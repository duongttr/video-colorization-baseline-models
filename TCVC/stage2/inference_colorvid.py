...
def get_args_parser():
    ...
    parser.add_argument('--model_path', type=str, 
                        default="./checkpoints/checkpoint_encoder_finetune02010000.pth")
    parser.add_argument('--decoder_path', type=str, 
                        default="./checkpoints/checkpoint_decoder_finetune02010000.pth")
    # * Backbone
    ...
    parser.add_argument('--ref_path', default='')  #./stage1_test_results
...
def main_testonly_parallel(args):
    ...
    for index,subdir in enumerate(tqdm(subdirs)):
        ...
        for j in range(0,len(Clip),test_num_frames-1):
            ...
            I_reference_rgb = tensor_lab2rgb(torch.cat((uncenter_l(clip_l[0:1,:,:,:]), clip_ref_ab), dim=1), device=device)
